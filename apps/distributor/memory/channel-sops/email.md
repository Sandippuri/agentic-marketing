...
> Fill this in during Phase 7 Day 5 with your actual email standards.
...
- Test against your own list over time; override these defaults once you have data.
...
- (List your actual HubSpot/Mailchimp list IDs here once known)
- Default broadcast list: `...`
- Engaged segment (opened in last 90 days): `...`
